...
if("FALSE" STREQUAL "TRUE")
  set(rethink_ee_description_SOURCE_PREFIX /home/evana/apv_ws/src/non_sim_baxter_stuff/baxter_common/rethink_ee_description)
  set(rethink_ee_description_DEVEL_PREFIX /home/evana/apv_ws/devel)
  ...
  set(rethink_ee_description_INSTALL_PREFIX /home/evana/apv_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rethink_ee_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/evana/apv_ws/install/${idir}'.  ${_report}")
    endif()
